...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TreasuryPulse India — Daily Treasury Intelligence by Pranav Chudgar, CFA",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "Daily RBI/SEBI updates, forex, G-sec & insider treasury intelligence by Pranav Chudgar, CFA · McKinsey. ₹50/month.",
    images: ["/og-image.png"],
  },
